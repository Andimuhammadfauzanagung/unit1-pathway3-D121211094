...
fun MiddlePart() {
    ...
    Column(
        ...
        Text(text = "Zanistism", fontSize = 30.sp, modifier = Modifier.padding(top = 16.dp))
    ...
    Tugas1Theme {
        ...
        MiddlePart()
            Column(
                ...
                DataRow(text = "08777604231", icon = Icons.Default.Call)
                DataRow(text = "@Zanist", icon = Icons.Default.Share)
                DataRow(text = "andimuhammadfauzanagung.com", icon = Icons.Default.Email)
            }
        }
    }
}